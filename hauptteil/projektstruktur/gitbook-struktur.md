...
Die nächste Konfigurationsvariable structure ermöglicht es, wie oben im Punkt SUMMARY.md beschrieben, die Gitbook spezifischen Standarddateien neu zu benennen. Als Beispiel kann die Datei README.md in Abstracts.md umbenannt werden. 
